...
# "Ani" არის ცვლადისთვის მნიშვნელობა
surname = "afanasieva"

# print(name)
# # პრინტ ფუნქციას გადაეცემა ეკრანზე გამოსატანი ობიექტი

# name = "Ani" # ეს არის str(string) ტიპის ცვლადი
...
# print(type(age)) # age გადაეცა type ფუნქციას, რომელმაც დააბრუნა მისი ტიპი(უბრუნებს მის პირვანდელ სახეს)
